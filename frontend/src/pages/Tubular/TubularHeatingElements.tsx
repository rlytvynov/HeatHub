...
export default function TubularHeatingElements({}: Props) {
    ...
    const handleFiltersApply = useCallback(() => {
        ...
        if (filters) {
            const filteredItems = items.filter(item => {
                ...
                const matchesShape = filters.shapes[item.shape as Tubular.ShapeType];
                const matchesFittingDiameter = filters.fittingDiameters[item.fittingDiameter as Tubular.FittingDiameterType];
                const matchesTubeDiameter = filters.tubeDiameters[item.tubeDiameter as Tubular.TubeDiameterType];
    ...
    return (
        <>
            <ContentLayout header='Tubular heating elements'>
                <div className="items">
